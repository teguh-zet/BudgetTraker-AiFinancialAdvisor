...
const fetchAllCategories = async ()=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/category', {
...
"[project]/src/utils/convertNumRupiah.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$convertNumRupiah$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/convertNumRupiah.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const TransactionForm = ({ initialData, onSubmit })=>{
    ...
    const handleChange = (e)=>{
        ...
        if (name === "amount") {
            ...
            const formatted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$convertNumRupiah$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(clean);
            setForm((prev)=>({
                    ...prev,
                    amount: formatted
                }));
...
function CreateTransactionPage() {
    ...
    const [isSubmitting, setISubmitting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
...
//# sourceMappingURL=src_3fc2979a._.js.map